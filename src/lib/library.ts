...
// ---------------------------------------------------------------------------
// ntree's library "store" — the single home for the app's DB + config.
//
...
//
// ndisc, nsmpl and ntree each carry a near-identical shape:
...
//     snapshot in state, save() on mutation. ntree's DB is a JSON report;
